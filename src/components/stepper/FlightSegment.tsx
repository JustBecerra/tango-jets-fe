            ...
            <table className="w-full">
              <thead className="border-b">
                <tr className="text-left text-xs text-gray-500">
                  ...
                  <th className="pb-3 font-normal"></th>
                  <th className="pb-3 font-normal"></th>
                  <th className="pb-3 font-normal text-right">DIST (NM)</th>
                  <th className="pb-3 font-normal text-right">ETR</th>
                  <th className="pb-3 font-normal"></th>
                </tr>
              </thead>
              <tbody>
            ...
            <div className="mt-8 border-t pt-4">
              <div className="grid grid-cols-3 text-sm">
                <div className="text-center">
                  ...
                  <div className="text-cyan-500 font-medium mt-1">8:12 (8.2 hrs)</div>
                  <div className="text-cyan-500 font-medium">9:30 (9.0 hrs)</div>
                </div>
                <div className="text-center">
                  <div className="font-medium">Live</div>
                  <div className="text-cyan-500 font-medium mt-1">7:12 (7.2 hrs)</div>
                  <div className="text-cyan-500 font-medium">7:36 (7.6 hrs)</div>
                </div>
                <div className="text-center">
                  <div className="font-medium">Total</div>
                  <div className="text-cyan-500 font-medium mt-1">15:24 (15.4 hrs)</div>
                  <div className="text-cyan-500 font-medium">16:36 (16.6 hrs)</div>
                </div>
              </div>
