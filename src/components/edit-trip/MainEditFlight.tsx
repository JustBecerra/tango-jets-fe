...
export const MainEditFlight = ({
  ...
  const addCompanionOption = (e: any) => {
    ...
    setFormData((prev) => ({
      ...prev,
      companion_passengers: [...prev.companion_passengers, "New Passenger"],
    }));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      convertedData.append("price_revenue", formData.price_revenue.toString());
      convertedData.append(
  ...
  return (
    <div className="w-[800px] h-[600px]">
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <div>
          <label htmlFor="airship_title" className="block text-sm font-medium">
            Airship Name
          </label>
          <select
            onChange={(e) =>
        ...
        <div className="flex gap-2">
          <div className="w-1/2">
            <label htmlFor="price_cost" className="block text-sm font-medium">
              Price cost
            </label>
            <input
              ...
              onChange={(e) =>
                setFormData((prevFormData) => ({
                  ...
                  price_revenue: getPercentage({
                    cost: e.target.value,
                    newPercentage: revenuePercentage.toString(),
                  }),
                }))
              }
              type="number"
          ...
          <div className="w-1/2">
            ...
            >
              ...
              <input
                ...
                onChange={(e) => {
                  setRevenuePercentage(parseFloat(e.target.value)),
                    setFormData((prevFormData) => ({
                      ...prevFormData,
        ...
        <div className="grid grid-cols-3 w-full gap-2">
          {formData.companion_passengers.length > 0 ? (
            formData.companion_passengers.map((companion, index) => (
              <div className="w-full" key={index}>
                ...
                <div className="w-full flex items-center justify-center">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData((prevFormData) => ({
                        ...prevFormData,
                        companion_passengers:
                          prevFormData.companion_passengers.map((c, i) =>
                  ...
                  />
                  <button
                    onClick={(e) => handleDeleteCompanion(e, companion)}
                    type="button"
            ...
            <div className="flex items-center justify-center">
              <p className=" text-center">No companion passengers assigned</p>
            </div>
          )}
