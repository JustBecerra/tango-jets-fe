...
const SignaturePad = ({ contractData }) => {
  ...
  const drawContract = (ctx, baseImage, secondImage) => {
    ...
    ctx.fillText(`Amount: $${contractData.amount}`, 50, 200); // Example: Amount
  ...
  useEffect(() => {
    ...
    secondImage.src = "../src/components/ContractSign/Contrato_page-0002.jpg"; // Replace with the actual path to your second image
  ...
  const clearSignature = () => {
    ...
    baseImage.onload = () => {
      secondImage.onload = () => {
        ...
        ctx.drawImage(secondImage, 0, baseImage.height, canvas.width, secondImage.height);
      };
    };
  };
