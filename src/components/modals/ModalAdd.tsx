    ...
    try {
      ...
      if (err instanceof z.ZodError) {
        const newErrors = {
          ...
          nationality:
            err.errors.find((e) => e.path[0] === "nationality")?.message || "",
          email: err.errors.find((e) => e.path[0] === "email")?.message || "",
          identification:
            err.errors.find((e) => e.path[0] === "identification")?.message ||
            "",
          passport:
          ...
          date_of_birth:
            ...
            "",
          title: err.errors.find((e) => e.path[0] === "title")?.message || "",
        };
        setErrors(newErrors);
      }
    } finally {
  ...
  return (
    <>
      ...
      >
        ...
        <span className="text-sm font-medium text-gray-800">New Client</span>
      </button>
