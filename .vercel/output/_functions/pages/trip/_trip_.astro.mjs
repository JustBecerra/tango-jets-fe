/* empty css                                       */
import { c as createComponent, r as renderTemplate, a as renderComponent } from '../../chunks/astro/server_DwpHebLD.mjs';
import 'kleur/colors';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { useState, useEffect } from 'react';
import { useParams } from 'react-router-dom';
import { u as useStore, p as putCompletePhase, b as getFlightById, g as getFlights, $ as $$Layout } from '../../chunks/actions_MIoFgvcc.mjs';
...
function TripPage() {
  ...
  return /* @__PURE__ */ jsx(RouteGuard, { children: /* @__PURE__ */ jsx(EditStepperFrame, { flightRequested: flight }) });
}

const prerender = false;
const $$trip = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Trip" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "TripPage", TripPage, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/Justo/Desktop/tango-jets-fe/src/components/stepper/TripPage", "client:component-export": "default" })} ` })}`;
