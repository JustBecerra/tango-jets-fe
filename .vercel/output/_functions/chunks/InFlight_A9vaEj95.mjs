...
const InFlight = ({ flights }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-full overflow-y-auto rounded-lg shadow-lg scrollbar-hide", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
    ...
    /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200 rounded-b-lg", children: flights.map((flight) => /* @__PURE__ */ jsxs(
      "tr",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 hidden md:table-cell text-center whitespace-nowrap text-xs text-gray-700", children: formatLandingTime(flight.launchtime) })
        ]
      },
      flight.id
    )) })
