...
const RecentlyLanded = ({ flights }) => {
  const formatLandingTime = (launchtime) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-full overflow-y-auto rounded-lg shadow-lg scrollbar-hide", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
    /* @__PURE__ */ jsxs("thead", { className: "bg-gray-50 sticky top-0 z-10", children: [
      ...
      /* @__PURE__ */ jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsx("th", { className: "px-6 py-3 hidden lg:table-cell text-center text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Time" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("tbody", { className: "bg-white divide-y divide-gray-200 rounded-b-lg", children: filteredFlights.map((flight) => /* @__PURE__ */ jsxs(
      "tr",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-center whitespace-nowrap text-xs font-medium text-gray-900", children: flight.airship_name }),
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 text-center whitespace-nowrap text-xs text-gray-700", children: [
            flight.from,
            /* @__PURE__ */ jsx(
              "svg",
              {
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 hidden lg:table-cell text-center whitespace-nowrap text-xs text-gray-700", children: formatLandingTime(flight.launchtime) })
        ]
      },
      flight.id
    )) })
...
export { RecentlyLanded as default };
