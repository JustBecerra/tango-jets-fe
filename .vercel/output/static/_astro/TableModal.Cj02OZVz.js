import { j as n } from "./jsx-runtime.CDeAccHH.js";
import { r as T } from "./index.CqbGxsOR.js";
import {
  a as Me,
  b as lt,
  B as Ve,
  ...
  H as De,
  f as ut,
} from "./FlightInfo.DM64rt0F.js";
import { L as X } from "./LoaderSpinner.t290QIza.js";
import { u as le, g as ht, a as ft } from "./actions.DqSaCuXh.js";
import { a as We, g as Ge, b as mt, c as gt } from "./actions.RyZlm8nd.js";
import { g as pt } from "./getCookie.CtV4NB4x.js";
import "./index.D2MAbzvX.js";
import "./index.Cb2GqDXq.js";
async function yt({ caseType: r, id: e }) {
  try {
    const t = await fetch(`https://vuelos-be.onrender.com/${r}/${e}`, {
      method: "DELETE",
    ...
    throw (console.error("Error deleting element:", t), t);
  }
}
const xt = ({ id: r, caseType: e, setData: t }) => {
    const [a, s] = T.useState(!1),
      [i, o] = T.useState(!1),
      { updateFlights: d, updateAirships: u, updateClients: c } = le((g) => g),
      h = async () => {
        o(!0);
        try {
          if ((await yt({ caseType: e, id: r }), e === "flight")) {
            const g = await ht();
            t(
              g
                .map((C) => {
                  const { updatedAt: b, ...N } = C;
                  return N;
                })
                .filter((C) => {
                  const b = new Date(C.launchtime);
                  return new Date() < b;
                })
            ),
              d(g);
          ...
          children: [
            ...
            n.jsx(Me.Body, {
              children: n.jsxs("div", {
                ...
                children: [
                  n.jsx(lt, {
                    className: "mx-auto mb-4 h-14 w-14 text-gray-900",
                  }),
                  n.jsxs("h3", {
                    className: "mb-5 text-lg font-normal text-gray-900",
                    children: [
  ...
  bt = () => {
    const [r, e] = T.useState(!1),
      [t, a] = T.useState(!1),
      [s, i] = T.useState(!1),
      [o, d] = T.useState("first"),
      [u, c] = T.useState({
        launchtime: new Date(),
        to: "",
        from: "",
      ...
      g = async (C) => {
        ...
        const {
          ...
          B = pt("username"),
          Ie = {
            launchtime: b.toISOString().slice(0, 16),
            to: N,
            from: w,
            price_cost: A,
            price_revenue: j,
        ...
        try {
          ...
          console.error("Error adding flight:", dt);
        } finally {
          i(!1);
        }
      };
    return n.jsxs(n.Fragment, {
      children: [
        n.jsx("button", {
          id: "addFlightButton",
          className:
            "block text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800",
          type: "button",
          onClick: h,
          children: "Add Flight",
        }),
        r &&
          n.jsx("div", {
            ...
            "aria-hidden": "true",
            className:
              "fixed inset-0 z-50 flex items-center justify-center p-4 overflow-x-hidden overflow-y-auto backdrop-filter backdrop-blur-sm bg-opacity-50",
            children: n.jsx("div", {
                ...
                children: [
                  ...
                  n.jsx("div", {
                    ...
                    children: n.jsxs("form", {
                      ...
                      onSubmit: g,
                      children: [
                        n.jsx(ct, { phase: o, formData: u, setFormData: c }),
                        n.jsx(Je, { phase: o, setPhase: d, operation: "add" }),
                      ],
                    }),
                  }),
                ],
            ...
            children: n.jsxs(ae, {
              children: [
                n.jsx("div", {
                  ...
                  children: n.jsx(De, { className: "h-5 w-5" }),
                }),
                n.jsx("div", {
                  className: "ml-3 text-sm font-normal",
                  children: "Flight added successfully.",
                }),
                n.jsx(ae.Toggle, { onClick: () => a(!1) }),
              ],
            }),
          }),
      ],
  ...
  vt = ({ loading: r }) =>
    n.jsx(n.Fragment, {
      children: r
        ...
        : n.jsxs(n.Fragment, {
            children: [
              n.jsx("div", { className: "mb-2", children: n.jsx(bt, {}) }),
              n.jsx("div", {
                className:
                  "flex justify-center items-center border-2 border-white rounded-lg h-[400px] w-[400px]",
                children: n.jsx("h2", {
...
async function kt({ caseType: r, data: e, id: t }) {
  try {
    e.append("id", t.toString());
    const a = `https://vuelos-be.onrender.com/${r}`;
    let s;
    r === "airship" ? (s = e) : (s = JSON.stringify(Object.fromEntries(e)));
    const i = await fetch(a, {
      method: "PUT",
      body: s,
      headers:
        r !== "airship" ? { "Content-Type": "application/json" } : void 0,
    });
    if (!i.ok) throw new Error(`HTTP error! Status: ${i.status}`);
    const o = await i.text();
    return o ? JSON.parse(o) : {};
  } catch (a) {
    throw (console.error("Error editing element:", a), a);
  }
}
const He = [
    "Afghan",
  ...
  _t = ({ formData: r, handleChange: e, handleEdit: t, setOpenModal: a }) => {
    const [s, i] = T.useState(!1),
      o = async (d) => {
        ...
        try {
          ...
          console.error("Error editing client:", u);
        } finally {
          i(!1);
        }
      };
              ...
              n.jsx("div", {
                ...
                children: n.jsxs("form", {
                  ...
                  children: [
                    n.jsxs("div", {
                      className:
                        "h-fit mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2",
                      children: [
                        n.jsxs("div", {
                          children: [
                            n.jsx("label", {
                            ...
                            n.jsx("input", {
                              ...
                              onChange: e,
                              className:
                                "block w-full px-4 py-2 mt-1 text-sm text-gray-900 bg-gray-50 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500",
                              required: !0,
                            }),
                          ],
                        }),
                          ...
                          children: [
                            ...
                            n.jsxs("select", {
                              ...
                              children: [
                                ...
                                He.map((d) =>
                                  n.jsx("option", { value: d, children: d })
                                ),
                              ],
                            }),
                          ],
                    ...
                    n.jsxs("div", {
                      className:
                        "flex justify-start items-center py-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600",
                      children: [
                        n.jsx("button", {
                          id: "submitEdit",
                          type: "submit",
  ...
  Ye = ({
    ...
    n.jsxs("div", {
      children: [
        ...
        n.jsx("div", {
          onDragOver: r,
          onDrop: (s) => e({ event: s, type: "portrait" }),
          ...
          children: n.jsxs("label", {
            ...
            children: [
              ...
              n.jsx("input", {
                ...
                name: "portrait",
                className: "hidden",
                onChange: (s) => t({ event: s, type: "portrait" }),
              }),
            ],
          }),
        }),
  ...
  Ke = ({
    ...
    n.jsxs("div", {
      children: [
        ...
        n.jsx("div", {
          onDragOver: r,
          onDrop: (s) => e({ event: s, type: "generic" }),
          className: "flex items-center justify-center w-full mt-1",
          children: n.jsxs("label", {
            className:
              "flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600",
            children: [
              n.jsxs("div", {
                className:
                  "flex flex-col w-full items-center justify-center pt-5 pb-6",
                children: [
                  n.jsx("svg", {
                    className: "w-8 h-8 mb-4 text-gray-500 dark:text-gray-400",
                    "aria-hidden": "true",
                  ...
                  a.length > 0
                    ? a.map((s, i) =>
                        n.jsx(
                          "p",
                          { className: "w-full truncate", children: s.name },
                          i
                        )
                      )
                    : n.jsxs(n.Fragment, {
              ...
              n.jsx("input", {
                ...
                multiple: !0,
                className: "hidden",
                onChange: (s) => t({ event: s, type: "generic" }),
              }),
            ],
          }),
        }),
    ...
    const [u, c] = T.useState(!1),
      h = async (N) => {
        ...
        try {
          ...
          console.error("Error editing jet:", w);
        } finally {
          c(!1);
        }
      },
      g = ({ event: N, type: w }) => {
        if (w === "generic") {
          const A = Array.from(N.target.files || []);
          o((j) => [...j, ...A]);
        } else if (w === "portrait" && N.target.files) {
          const A = N.target.files[0];
          d(A);
        }
      },
      C = ({ event: N, type: w }) => {
        if ((N.preventDefault(), N.stopPropagation(), w === "generic")) {
          const A = Array.from(N.dataTransfer.files);
          o((j) => [...j, ...A]);
        } else if (w === "portrait") {
  ...
  jt = ({ formData: r, handleChange: e, phase: t }) => {
    const a = () =>
      t === "first"
        ? n.jsxs("div", {
            className: "h-fit mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2",
            children: [
              n.jsxs("div", {
                children: [
                  n.jsx("label", {
        ...
        : n.jsxs("div", {
            className: "h-fit mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2",
            children: [
              n.jsxs("h2", { children: ["to: ", r.to] }),
              n.jsxs("h2", { children: ["from: ", r.from] }),
              n.jsxs("h2", {
                children: ["launch time: ", r.launchtime.slice(0, 16)],
              }),
              n.jsxs("h2", {
                children: ["master passenger: ", r.master_passenger],
              }),
              n.jsxs("h2", { children: ["airship: ", r.airship_name] }),
              n.jsxs("h2", { children: ["cost: ", r.price_cost] }),
              n.jsxs("h2", {
                children: ["cost plus revenue: ", r.price_revenue],
              }),
            ],
          });
    return n.jsx(n.Fragment, { children: a() });
  },
  Nt = ({ formData: r, handleChange: e, handleEdit: t, setOpenModal: a }) => {
    const [s, i] = T.useState("first");
    return n.jsx("div", {
      id: "editFlightModal",
      tabIndex: -1,
      "aria-hidden": "true",
          ...
          children: [
            ...
            n.jsx("div", {
              ...
              children: n.jsxs("form", {
                ...
                onSubmit: t,
                children: [
                  n.jsx(jt, { formData: r, handleChange: e, phase: s }),
                  n.jsx(Je, { phase: s, setPhase: i, operation: "edit" }),
                ],
              }),
            }),
          ],
  ...
  Ct = ({ id: r, caseType: e, data: t }) => {
    const [a, s] = T.useState(!1),
      ...
      [c, h] = T.useState([]),
      { updateClients: g, updateAirships: C } = le(),
      b = async (w) => {
        w.preventDefault();
        ...
        try {
          if ((await kt({ caseType: e, data: j, id: r }), e === "client")) {
            const E = await We();
            g(E);
          } else if (e === "airship") {
            const E = await Ge();
...
(function (r) {
  ...
  (r.assertNever = t),
    ...
    (r.getValidEnumValues = (s) => {
      const i = r.objectKeys(s).filter((d) => typeof s[s[d]] != "number"),
        o = {};
      for (const d of i) o[d] = s[d];
      return r.objectValues(o);
    }),
    (r.objectValues = (s) =>
      r.objectKeys(s).map(function (i) {
        return s[i];
      })),
    (r.objectKeys =
    ...
    const t =
      ...
      s = (i) => {
        for (const o of i.issues)
          ...
          else if (o.path.length === 0) a._errors.push(t(o));
          else {
            let d = a,
              u = 0;
            for (; u < o.path.length; ) {
              const c = o.path[u];
              u === o.path.length - 1
                ? ((d[c] = d[c] || { _errors: [] }), d[c]._errors.push(t(o)))
                : (d[c] = d[c] || { _errors: [] }),
                (d = d[c]),
                u++;
            }
...
const se = (r, e) => {
  ...
  switch (r.code) {
    ...
    case l.invalid_enum_value:
      t = `Invalid enum value. Expected ${_.joinValues(r.options)}, received '${
        r.received
      }'`;
      break;
...
const Ce = (r) => {
    ...
    const u = a
      ...
      .slice()
      .reverse();
    for (const c of u) d = c(o, { data: e, defaultError: d }).message;
...
class Z {
  ...
  static mergeObjectSync(e, t) {
    ...
    for (const s of t) {
      ...
      if (i.status === "aborted" || o.status === "aborted") return x;
...
const x = Object.freeze({ status: "aborted" }),
  ...
  O = (r) => ({ status: "valid", value: r }),
  Le = (r) => r.status === "aborted",
  ze = (r) => r.status === "dirty",
  Y = (r) => r.status === "valid",
...
const Be = (r, e) => {
  if (Y(e)) return { success: !0, data: e.value };
    ...
    : {
        errorMap: (o, d) => {
          ...
          return o.code === "invalid_enum_value"
            ...
            ? {
                message:
                  (u = h ?? a) !== null && u !== void 0 ? u : d.defaultError,
              }
            : o.code !== "invalid_type"
            ? { message: d.defaultError }
            : {
                message:
                  (c = h ?? t) !== null && c !== void 0 ? c : d.defaultError,
              };
        },
        description: s,
      };
...
class k {
  ...
  "~validate"(e) {
    ...
    if (!this["~standard"].async)
      try {
        ...
        return Y(i) ? { value: i.value } : { issues: s.common.issues };
      } catch (i) {
        !(
          (a =
            (t = i?.message) === null || t === void 0
              ? void 0
              : t.toLowerCase()) === null || a === void 0
        ) &&
    ...
    return this._parseAsync({ data: e, path: [], parent: s }).then((i) =>
      Y(i) ? { value: i.value } : { issues: s.common.issues }
    );
  }
  ...
  async safeParseAsync(e, t) {
    const a = {
      ...
      i = await (ce(s) ? s : Promise.resolve(s));
    return Be(a, i);
  }
  refine(e, t) {
    const a = (s) =>
    ...
    return this._refinement((s, i) => {
      const o = e(s),
        d = () => i.addIssue({ code: l.custom, ...a(s) });
  ...
  brand() {
    return new $e({ typeName: y.ZodBranded, type: this, ...v(this._def) });
  }
  catch(e) {
    const t = typeof e == "function" ? e : () => e;
    return new ke({
...
const Et = /^c[^\s-]{8,}$/i,
  ...
  zt = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let Re;
const Pt =
  ...
  Bt = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
...
function Yt(r, e) {
  const t = (r.toString().split(".")[1] || "").length,
    ...
    s = t > a ? t : a,
    i = parseInt(r.toFixed(s).replace(".", "")),
...
class U extends k {
    ...
    for (const i of this._def.checks)
      i.kind === "int"
        ...
        ? Number.isFinite(e.data) ||
          ((a = this._getOrReturnCtx(e, a)),
          f(a, { code: l.not_finite, message: i.message }),
          s.dirty())
        : _.assertNever(i);
  ...
  setLimit(e, t, a, s) {
    return new U({
      ...
      checks: [
        ...this._def.checks,
        { kind: e, value: t, inclusive: a, message: p.toString(s) },
      ],
    });
  }
  _addCheck(e) {
  ...
  get isInt() {
    return !!this._def.checks.find(
      (e) =>
        e.kind === "int" || (e.kind === "multipleOf" && _.isInteger(e.value))
    );
  }
  get isFinite() {
    let e = null,
...
ue.create = (r) =>
  new ue({ typeName: y.ZodBoolean, coerce: r?.coerce || !1, ...v(r) });
class K extends k {
  _parse(e) {
    if (
    ...
    if (isNaN(e.data.getTime())) {
      const i = this._getOrReturnCtx(e);
      return f(i, { code: l.invalid_date }), x;
    }
    const a = new Z();
    let s;
    for (const i of this._def.checks)
...
K.create = (r) =>
  new K({ checks: [], coerce: r?.coerce || !1, typeName: y.ZodDate, ...v(r) });
class Se extends k {
  _parse(e) {
...
Se.create = (r) => new Se({ typeName: y.ZodSymbol, ...v(r) });
class he extends k {
  _parse(e) {
...
he.create = (r) => new he({ typeName: y.ZodUndefined, ...v(r) });
class fe extends k {
  _parse(e) {
...
fe.create = (r) => new fe({ typeName: y.ZodNull, ...v(r) });
class ne extends k {
  constructor() {
...
ne.create = (r) => new ne({ typeName: y.ZodAny, ...v(r) });
class H extends k {
  constructor() {
...
H.create = (r) => new H({ typeName: y.ZodUnknown, ...v(r) });
class V extends k {
  _parse(e) {
    const t = this._getOrReturnCtx(e);
    return (
      f(t, { code: l.invalid_type, expected: m.never, received: t.parsedType }),
      x
    );
  }
}
V.create = (r) => new V({ typeName: y.ZodNever, ...v(r) });
class Ae extends k {
  _parse(e) {
    if (this._getType(e) !== m.undefined) {
      const a = this._getOrReturnCtx(e);
...
Ae.create = (r) => new Ae({ typeName: y.ZodVoid, ...v(r) });
class R extends k {
  _parse(e) {
    ...
    if (
      ...
      return Promise.all(
        [...t.data].map((o, d) => s.type._parseAsync(new z(t, o, t.path, d)))
      ).then((o) => Z.mergeArray(a, o));
    const i = [...t.data].map((o, d) =>
      s.type._parseSync(new z(t, o, t.path, d))
    );
...
function ee(r) {
  if (r instanceof S) {
    ...
    return new S({ ...r._def, shape: () => e });
  } else
    return r instanceof R
      ? new R({ ...r._def, type: ee(r.element) })
      : r instanceof L
      ? L.create(ee(r.unwrap()))
      : r instanceof G
      ? G.create(ee(r.unwrap()))
      : r instanceof P
      ? P.create(r.items.map((e) => ee(e)))
      : r;
}
class S extends k {
  constructor() {
  ...
  _parse(e) {
    ...
    if (!(this._def.catchall instanceof V && this._def.unknownKeys === "strip"))
      for (const c in s.data) o.includes(c) || d.push(c);
    const u = [];
    for (const c of o) {
      const h = i[c],
        g = s.data[c];
      u.push({
        ...
        value: h._parse(new z(s, g, s.path, c)),
    ...
    if (this._def.catchall instanceof V) {
      ...
      if (c === "passthrough")
        ...
        d.length > 0 &&
          (f(s, { code: l.unrecognized_keys, keys: d }), a.dirty());
      else if (c !== "strip")
      ...
      for (const h of d) {
        ...
        u.push({
          key: { status: "valid", value: h },
          value: c._parse(new z(s, g, s.path, h)),
      ...
      ? Promise.resolve()
          .then(async () => {
            ...
            for (const h of u) {
              const g = await h.key,
                C = await h.value;
              c.push({ key: g, value: C, alwaysSet: h.alwaysSet });
            }
            return c;
          })
          .then((c) => Z.mergeObjectSync(a, c))
      : Z.mergeObjectSync(a, u);
  }
  get shape() {
                ...
                const u =
                  (o =
                    (i = (s = this._def).errorMap) === null || i === void 0
                      ? void 0
                      : i.call(s, t, a).message) !== null && o !== void 0
                    ? o
                    : a.defaultError;
                return t.code === "unrecognized_keys"
                  ? {
                      message:
                        (d = p.errToObj(e).message) !== null && d !== void 0
                          ? d
                          : u,
                    }
                  : { message: u };
  ...
  omit(e) {
    const t = {};
    return (
      _.objectKeys(this.shape).forEach((a) => {
  ...
  keyof() {
    return at(_.objectKeys(this.shape));
  }
}
S.create = (r, e) =>
  new S({
...
class me extends k {
  _parse(e) {
    ...
    function s(i) {
      ...
      const o = i.map((d) => new I(d.ctx.common.issues));
      return f(t, { code: l.invalid_union, unionErrors: o }), x;
    }
    if (t.common.async)
      return Promise.all(
        a.map(async (i) => {
...
me.create = (r, e) => new me({ options: r, typeName: y.ZodUnion, ...v(e) });
const D = (r) =>
  r instanceof ye
    ? D(r.schema)
    : r instanceof F
    ...
    : r instanceof G
    ? [null, ...D(r.unwrap())]
    : r instanceof $e || r instanceof _e
    ? D(r.unwrap())
    : r instanceof ke
    ? D(r._def.innerType)
    : [];
...
function Pe(r, e) {
  ...
  if (t === m.object && a === m.object) {
    const s = _.objectKeys(e),
      i = _.objectKeys(r).filter((d) => s.indexOf(d) !== -1),
      o = { ...r, ...e };
    for (const d of i) {
      const u = Pe(r[d], e[d]);
...
class ge extends k {
  _parse(e) {
    const { status: t, ctx: a } = this._processInputParams(e),
      s = (i, o) => {
        if (Le(i) || Le(o)) return x;
        const d = Pe(i.value, o.value);
        return d.valid
          ? ((ze(i) || ze(o)) && t.dirty(), { status: t.value, value: d.data })
          : (f(a, { code: l.invalid_intersection_types }), x);
      };
...
ge.create = (r, e, t) =>
  new ge({ left: r, right: e, typeName: y.ZodIntersection, ...v(t) });
class P extends k {
  _parse(e) {
    const { status: t, ctx: a } = this._processInputParams(e);
    ...
    const i = [...a.data]
      .map((o, d) => {
        ...
        return u ? u._parse(new z(a, o, a.path, d)) : null;
      })
      .filter((o) => !!o);
    return a.common.async
      ? Promise.all(i).then((o) => Z.mergeArray(t, o))
      : Z.mergeArray(t, i);
  }
  get items() {
  ...
  rest(e) {
    return new P({ ...this._def, rest: e });
  }
}
P.create = (r, e) => {
  if (!Array.isArray(r))
    throw new Error("You must pass an array of schemas to z.tuple([ ... ])");
  return new P({ items: r, typeName: y.ZodTuple, rest: null, ...v(e) });
};
class pe extends k {
  get keySchema() {
  ...
  _parse(e) {
    ...
    for (const d in a.data)
      s.push({
        key: i._parse(new z(a, d, a.path, d)),
        value: o._parse(new z(a, a.data[d], a.path, d)),
        alwaysSet: d in a.data,
      });
    return a.common.async ? Z.mergeObjectAsync(t, s) : Z.mergeObjectSync(t, s);
  }
  get element() {
    return this._def.valueType;
  }
  static create(e, t, a) {
    return t instanceof k
      ? new pe({ keyType: e, valueType: t, typeName: y.ZodRecord, ...v(a) })
      : new pe({
          keyType: M.create(),
          valueType: e,
...
class Ee extends k {
  ...
  _parse(e) {
    ...
    if (a.parsedType !== m.map)
      return (
        f(a, { code: l.invalid_type, expected: m.map, received: a.parsedType }),
        x
      );
    const s = this._def.keyType,
      i = this._def.valueType,
      o = [...a.data.entries()].map(([d, u], c) => ({
        key: s._parse(new z(a, d, a.path, [c, "key"])),
        value: i._parse(new z(a, u, a.path, [c, "value"])),
      }));
    if (a.common.async) {
      const d = new Map();
      return Promise.resolve().then(async () => {
        for (const u of o) {
          const c = await u.key,
            h = await u.value;
          if (c.status === "aborted" || h.status === "aborted") return x;
          (c.status === "dirty" || h.status === "dirty") && t.dirty(),
            d.set(c.value, h.value);
        }
...
Ee.create = (r, e, t) =>
  new Ee({ valueType: e, keyType: r, typeName: y.ZodMap, ...v(t) });
class Q extends k {
  _parse(e) {
    const { status: t, ctx: a } = this._processInputParams(e);
    if (a.parsedType !== m.set)
      return (
        f(a, { code: l.invalid_type, expected: m.set, received: a.parsedType }),
        x
      );
    const s = this._def;
    s.minSize !== null &&
    ...
    const d = [...a.data.values()].map((u, c) =>
      i._parse(new z(a, u, a.path, c))
    );
    return a.common.async ? Promise.all(d).then((u) => o(u)) : o(d);
  }
  min(e, t) {
    return new Q({
      ...this._def,
...
class re extends k {
  ...
  _parse(e) {
    ...
    if (this._def.returns instanceof ie) {
      ...
      return O(async function (...u) {
        const c = new I([]),
          h = await d._def.args.parseAsync(u, i).catch((b) => {
            throw (c.addIssue(a(u, b)), c);
          }),
          g = await Reflect.apply(o, this, h);
        return await d._def.returns._def.type.parseAsync(g, i).catch((b) => {
          throw (c.addIssue(s(g, b)), c);
        });
      });
    } else {
      const d = this;
      return O(function (...u) {
        const c = d._def.args.safeParse(u, i);
        if (!c.success) throw new I([a(u, c.error)]);
        const h = Reflect.apply(o, this, c.data),
          g = d._def.returns.safeParse(h, i);
        if (!g.success) throw new I([s(h, g.error)]);
        return g.data;
      });
    }
  }
  ...
  args(...e) {
    return new re({ ...this._def, args: P.create(e).rest(H.create()) });
  }
  returns(e) {
    return new re({ ...this._def, returns: e });
  }
  implement(e) {
    return this.parse(e);
  }
...
ye.create = (r, e) => new ye({ getter: r, typeName: y.ZodLazy, ...v(e) });
class xe extends k {
  _parse(e) {
...
xe.create = (r, e) => new xe({ value: r, typeName: y.ZodLiteral, ...v(e) });
function at(r, e) {
  return new W({ values: r, typeName: y.ZodEnum, ...v(e) });
}
class W extends k {
  constructor() {
  ...
  _parse(e) {
    ...
    if (
      (Te(this, oe) || Xe(this, oe, new Set(this._def.values)),
      !Te(this, oe).has(e.data))
    ) {
      const t = this._getOrReturnCtx(e),
        a = this._def.values;
      return (
        f(t, { received: t.data, code: l.invalid_enum_value, options: a }), x
      );
    }
    return O(e.data);
  }
...
class be extends k {
  ...
  _parse(e) {
    ...
    if (
      (Te(this, de) ||
        Xe(this, de, new Set(_.getValidEnumValues(this._def.values))),
      !Te(this, de).has(e.data))
    ) {
      const s = _.objectValues(t);
      return (
        f(a, { received: a.data, code: l.invalid_enum_value, options: s }), x
      );
    }
    return O(e.data);
  }
...
de = new WeakMap();
be.create = (r, e) => new be({ values: r, typeName: y.ZodNativeEnum, ...v(e) });
class ie extends k {
  unwrap() {
    return this._def.type;
  }
...
ie.create = (r, e) => new ie({ type: r, typeName: y.ZodPromise, ...v(e) });
class F extends k {
  innerType() {
    ...
    if (s.type === "transform")
      if (a.common.async === !1) {
        ...
        return this._def.schema
          ...
          .then((o) =>
            Y(o)
              ? Promise.resolve(s.transform(o.value, i)).then((d) => ({
                  status: t.value,
                  value: d,
                }))
              : o
...
F.create = (r, e, t) =>
  new F({ schema: r, typeName: y.ZodEffects, effect: e, ...v(t) });
F.createWithPreprocess = (r, e, t) =>
  new F({
    schema: e,
...
L.create = (r, e) => new L({ innerType: r, typeName: y.ZodOptional, ...v(e) });
class G extends k {
  _parse(e) {
...
G.create = (r, e) => new G({ innerType: r, typeName: y.ZodNullable, ...v(e) });
class ve extends k {
  _parse(e) {
    const { ctx: t } = this._processInputParams(e);
    let a = t.data;
...
class Ze extends k {
  _parse(e) {
    if (this._getType(e) !== m.nan) {
      const a = this._getOrReturnCtx(e);
      return (
        f(a, { code: l.invalid_type, expected: m.nan, received: a.parsedType }),
        x
      );
    }
    return { status: "valid", value: e.data };
...
Ze.create = (r) => new Ze({ typeName: y.ZodNaN, ...v(r) });
...
class we extends k {
  ...
  static create(e, t) {
    return new we({ in: e, out: t, typeName: y.ZodPipeline });
  }
}
class _e extends k {
  _parse(e) {
    const t = this._def.innerType._parse(e),
      a = (s) => (Y(s) && (s.value = Object.freeze(s.value)), s);
    return ce(t) ? t.then((s) => a(s)) : a(t);
  }
  unwrap() {
    return this._def.innerType;
  }
...
_e.create = (r, e) =>
  new _e({ innerType: r, typeName: y.ZodReadonly, ...v(e) });
function st(r, e = {}, t) {
  return r
    ? ne.create().superRefine((a, s) => {
        var i, o;
        if (!r(a)) {
          const d =
              typeof e == "function"
                ...
                : e,
            u =
              (o = (i = d.fatal) !== null && i !== void 0 ? i : t) !== null &&
              o !== void 0
                ? o
                : !0,
            c = typeof d == "string" ? { message: d } : d;
          s.addIssue({ code: "custom", ...c, fatal: u });
        }
      })
    : ne.create();
}
const Qt = { object: S.lazycreate };
var y;
(function (r) {
...
const Xt = (r, e = { message: `Input not instance of ${r.name}` }) =>
    st((t) => t instanceof r, e),
  nt = M.create,
  it = U.create,
  er = Ze.create,
  tr = J.create,
  ...
  Ir = {
    ...
    boolean: (r) => ue.create({ ...r, coerce: !0 }),
    bigint: (r) => J.create({ ...r, coerce: !0 }),
    date: (r) => K.create({ ...r, coerce: !0 }),
  },
  Mr = x;
var q = Object.freeze({
  __proto__: null,
...
const Rr = q.object({
    fullname: q.string().refine((r) => r.trim().split(/\s+/).length >= 2),
    nationality: q.string(),
    email: q.string().email("it needs to be an email"),
    identification: q
      .string()
      .min(8, "ID needs to have a minimum of 8 characters"),
    passport: q.string().min(6, "ID needs to have a minimum of 6 characters"),
    weight: q.string().min(2, "needs to have a minimum of 2 characters"),
  }),
  Fr = () => {
    const [r, e] = T.useState(!1),
      [t, a] = T.useState(!1),
      ...
      c = async (h) => {
        ...
        try {
          const g = h.target,
            C = new FormData(g),
            b = Object.fromEntries(C.entries()),
            N = Rr.parse({
              fullname: b.fullname,
          ...
          if (
            (console.error("Error adding client:", g), g instanceof q.ZodError)
          ) {
            const C = {
              fullname:
                g.errors.find((b) => b.path[0] === "fullname")?.message || "",
              nationality:
                g.errors.find((b) => b.path[0] === "nationality")?.message ||
                "",
              email: g.errors.find((b) => b.path[0] === "email")?.message || "",
              identification:
                g.errors.find((b) => b.path[0] === "identification")?.message ||
                "",
              passport:
                g.errors.find((b) => b.path[0] === "passport")?.message || "",
              weight:
                g.errors.find((b) => b.path[0] === "weight")?.message || "",
            };
            d(C);
          }
        } finally {
                              ...
                              children: [
                                ...
                                n.jsxs("select", {
                                  ...
                                  children: [
                                    ...
                                    He.map((h) =>
                                      n.jsx("option", { value: h, children: h })
                                    ),
                                  ],
                                }),
                                o.nationality &&
          ...
          n.jsx("div", {
            ...
            children: n.jsxs(ae, {
              children: [
                ...
                n.jsx("div", {
                  className: "ml-3 text-sm font-normal",
                  children: "Client added successfully.",
                }),
                n.jsx(ae.Toggle, { onClick: () => a(!1) }),
              ],
            }),
  ...
  Lr = () => {
    const [r, e] = T.useState(!1),
      ...
      g = ({ event: w, type: A }) => {
        if ((w.preventDefault(), w.stopPropagation(), A === "generic")) {
          const j = Array.from(w.dataTransfer.files);
          c((E) => [...E, ...j]);
        } else if (A === "portrait") {
          const j = w.dataTransfer.files[0];
          d(j);
        }
      },
      C = ({ event: w, type: A }) => {
        if (A === "generic") {
          const j = Array.from(w.target.files || []);
          c((E) => [...E, ...j]);
        } else if (A === "portrait" && w.target.files) {
      ...
      N = async (w) => {
        w.preventDefault(), i(!0);
        const A = w.currentTarget,
          j = new FormData(A);
        j.set("title", j.get("title")),
          j.set("status", j.get("status")),
          j.set("seats", j.get("seats")),
          j.set("size", j.get("size"));
        const E = document.querySelector('input[name="generic"]');
        if (E?.files)
          for (let B = 0; B < E.files.length - 1; B++)
            j.append("generic", E.files[B]);
        const je = document.querySelector('input[name="portrait"]');
        je?.files && j.append("portrait", je.files[0]);
        try {
          const B = await gt(j);
          a(!0),
            setTimeout(() => {
          ...
          console.error("Error adding airship or uploading files:", B);
        } finally {
          i(!1);
        }
      };
          ...
          n.jsx("div", {
            ...
            children: n.jsxs(ae, {
              children: [
                ...
                n.jsx("div", {
                  className: "ml-3 text-sm font-normal",
                  children: "Jet added successfully.",
                }),
                n.jsx(ae.Toggle, { onClick: () => a(!1) }),
              ],
            }),
        ...
        try {
          r === "flight"
            ? t(
                i
                  .map((g) => {
                    const { updatedAt: C, ...b } = g;
                    return b;
                  })
                  .filter((g) => {
                    const C = new Date(g.launchtime);
                    return new Date() < C;
                  })
                  .map((g) => ({
                    ...g,
                    launchtime: new Date(g.launchtime).toLocaleString("en-US", {
                      month: "2-digit",
                      day: "numeric",
                      hour: "2-digit",
                      minute: "2-digit",
                    ...
                    createdAt: new Date(g.createdAt).toLocaleString("en-US", {
                      month: "2-digit",
                      day: "numeric",
                      hour: "2-digit",
                      minute: "2-digit",
          ...
          console.error("Failed to fetch data:", g);
        } finally {
          s(!1);
        }
      })();
    ...
    const u = () => {
      ...
      c = () =>
        r === "flight"
          ...
          : n.jsx(n.Fragment, {});
    return n.jsx("div", {
      className: " w-full max-w-[100%] shadow-md sm:rounded-lg",
      children:
        e.length > 0
          ? n.jsxs(n.Fragment, {
              children: [
                n.jsx("div", { className: "mb-2", children: c() }),
                n.jsxs("table", {
                  className:
                    "border-gray-400 w-full text-sm text-left rtl:text-right text-gray-500 overflow-y-auto",
                  children: [
                    n.jsx("thead", {
                      className:
                        "sticky top-0 text-xs text-gray-700 uppercase bg-gray-400",
                      children: n.jsxs("tr", {
                        children: [
                          Object.entries(e[0])
                            .filter(
                              ([h, g]) => h !== "pslc" && h !== "createdAt"
                            )
                            .map(([h, g], C) =>
                              n.jsx(
                                "th",
                      ...
                      children: e
                        ...
                        .map((h) =>
                          n.jsxs(
                            ...
                            {
                              className:
                                "bg-white border-b cursor-pointer hover:bg-gray-200",
                              children: [
                                  ...
                                  ([g, C]) => (
                                    ...
                                    n.jsx(
                                      "td",
                                      {
                                        onClick: () => {
                                          r === "flight" &&
                                            (window.location.href = `/trip/${h.id}`);
                                        },
                                        className:
                                ...
                                n.jsxs("td", {
                                  className: "px-6 py-3 flex whitespace-nowrap",
                                  children: [
                                    r !== "history" &&
                                      r !== "flight" &&
                                      n.jsx(Ct, {
          ...
          : n.jsx(n.Fragment, { children: n.jsx(vt, { loading: a }) }),
    });
  };
